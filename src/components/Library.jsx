      ...
      <div className="max-w-3xl mx-auto px-6 flex flex-col gap-0">
          ...
          <div className="flex gap-3 items-stretch">
            <div className="flex-1 relative">
              <svg
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--ds-gray-900)] pointer-events-none"
              >
              ...
              <input
                ...
                className="w-full h-11 pl-11 pr-4 rounded-xl border border-[var(--ds-gray-400)] bg-[var(--ds-gray-100)] text-copy-14 text-[var(--ds-gray-1000)] placeholder:text-[var(--ds-gray-900)] outline-none focus:border-[var(--ds-gray-600)] transition-colors"
              />
            </div>
            ...
            {allTags.length > 0 && (
              <div ref={tagsRef} className="relative">
                <button
                  ...
                  className={`
                    ...
                    ${selectedTags.length > 0
                      ? 'border-[var(--color-brand)] text-[var(--color-brand)] bg-[var(--ds-gray-100)]'
                      : 'border-[var(--ds-gray-400)] text-[var(--ds-gray-1000)] bg-[var(--ds-gray-100)] hover:border-[var(--ds-gray-600)]'
                    }
                  `}
                >
                  {selectedTags.length > 0 && (
                ...
                {tagsOpen && (
                  <div className="absolute right-0 top-full mt-2 w-[220px] rounded-xl border border-[var(--ds-gray-400)] bg-[var(--ds-gray-100)] shadow-lg z-50 overflow-hidden">
                    {allTags.length > 5 && (
                      <div className="px-3 pt-3 pb-2">
                        <input
                          ...
                          className="w-full h-8 px-3 rounded-lg border border-[var(--ds-gray-400)] bg-[var(--ds-gray-200)] text-copy-13 text-[var(--ds-gray-1000)] placeholder:text-[var(--ds-gray-900)] outline-none focus:border-[var(--ds-gray-600)] transition-colors"
                        />
                      </div>
                    )}
                        ...
                        return (
                          <>
                            {visible.map(tag => (
                              <label
                                key={tag}
                                className="flex items-center gap-3 px-4 py-2 cursor-pointer hover:bg-[var(--ds-gray-200)] transition-colors"
                              >
                                <input
                                  type="checkbox"
                            ...
                            {visible.length === 0 && (
                              <div className="px-4 py-3 text-copy-13 text-[var(--ds-gray-900)]">No tags found</div>
                            )}
                            {hasMore && (
                    ...
                    {selectedTags.length > 0 && (
                      <>
                        ...
                        <button
                          ...
                          className="w-full px-4 py-2.5 text-copy-14 text-[var(--ds-gray-900)] hover:text-[var(--ds-gray-1000)] hover:bg-[var(--ds-gray-alpha-100)] transition-colors cursor-pointer bg-transparent border-none text-center"
                        >
                          Clear all
                        </button>
                      </>
        ...
        <div className="py-4">
          {!loaded ? (
            ...
            <div className="py-16 text-center text-[var(--ds-gray-900)] text-copy-14">
        ...
        {fabOpen && (
          <div className="absolute bottom-full right-0 mb-3 flex flex-col gap-2">
            <button
              ...
              className="px-5 py-3 rounded-xl bg-[var(--ds-gray-100)] border border-[var(--ds-gray-400)] shadow-lg cursor-pointer hover:border-[var(--ds-gray-600)] transition-all duration-150 whitespace-nowrap text-label-14 text-[var(--ds-gray-1000)] text-left"
            >
              New Song
            </button>
            <button
