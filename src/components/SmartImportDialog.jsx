...
export default function SmartImportDialog({ onClose, onImport }) {
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-[var(--ds-background-200)] rounded-2xl border border-[var(--ds-gray-400)] w-full max-w-[1100px] max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <div className="flex items-center gap-2 px-5 py-4 border-b border-[var(--ds-gray-300)]">
          <div className="flex-1">
            ...
            <div className="text-copy-12 text-[var(--ds-gray-600)] mt-0.5">
              Paste a chord sheet from ChordPro, Ultimate Guitar, or plain lyrics.
            </div>
          </div>
        ...
        <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 gap-0 md:divide-x divide-[var(--ds-gray-300)] overflow-hidden">
          ...
          <div className="flex flex-col min-h-0 p-4">
            ...
            <textarea
              ...
              placeholder={EXAMPLE}
              spellCheck={false}
              className="flex-1 min-h-[220px] w-full bg-[var(--ds-gray-100)] border border-[var(--ds-gray-400)] rounded-lg p-3 text-copy-12 leading-relaxed text-[var(--ds-gray-1000)] resize-none outline-none font-mono whitespace-pre"
            />
        ...
        <div className="flex items-center gap-2 px-5 py-3 border-t border-[var(--ds-gray-300)]">
          <span className="text-label-11 text-[var(--ds-gray-500)] font-mono flex-1">
            Esc to cancel
          </span>
