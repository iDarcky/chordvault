  ...
  return (
    <Card onClick={onView} className="flex flex-col gap-6 cursor-pointer">
      <div className="flex justify-between items-start">
        <div className="text-label-12-mono text-default-500 tracking-widest uppercase">
          {dateStr}
        </div>
      ...
      <div>
        <h3 className="text-heading-20 text-foreground m-0 leading-tight">
          {setlist.name || 'Untitled Setlist'}
        </h3>
        <p className="text-copy-14 text-default-500 mt-2">
