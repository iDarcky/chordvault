  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 py-10 relative">
      ...
      <Button
        ...
        size="sm"
        onClick={onComplete}
        className="absolute top-5 right-5 text-default-500"
      >
        Skip
      </Button>
      ...
      {/* Title */}
      <h2 className="text-heading-24 text-foreground text-center m-0">
        {current.title}
      </h2>

      {/* Description */}
      <p className="text-copy-14 text-default-500 text-center mt-3 max-w-xs leading-relaxed">
        {current.description}
      </p>
