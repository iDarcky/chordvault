  ...
  return (
    <div className="min-h-screen material-page pb-32">
      ...
      {searchOpen && (
        ...
        >
          {/* Backdrop */}
          <div className="absolute inset-0 bg-[var(--ds-gray-100)] opacity-80" />
          ...
          >
            ...
            {searchQuery.trim() && (
              <div className="rounded-xl border border-[var(--ds-gray-400)] bg-[var(--ds-gray-100)] overflow-hidden divide-y divide-[var(--ds-gray-400)] shadow-lg">
                {searchResults.length > 0 ? (
                  ...
                  <div className="px-4 py-6 text-center text-copy-14 text-[var(--ds-gray-900)]">
                    No songs found.
                  </div>
                )}
              </div>
            ...
            <button
              onClick={() => setSearchOpen(false)}
              className="mt-2 self-center text-label-13 text-[var(--ds-gray-900)] hover:text-[var(--ds-gray-1000)] transition-colors bg-transparent border-none cursor-pointer"
            >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <button
            ...
            className="w-11 h-11 rounded-full bg-[var(--ds-gray-100)] border border-[var(--ds-gray-400)] shadow-lg flex items-center justify-center cursor-pointer hover:border-[var(--ds-gray-600)] transition-all duration-150 active:scale-95"
          >
